...
namespace Chat
{
    ...
    public class Server
    {
        public interface IListener
        {
            ...
            public void OnReceiveData(AsyncUserToken token, byte[] buff);

            public void stopedDel();
        }
        ...
        public void SetListener(IListener _listener)
        {
        ...
        private void ProcessAccept(SocketAsyncEventArgs e)
        {
            try
            {
                ...
                if (listener != null)
                    listener.OnClientNumberChange(1, userToken);
            ...
            try
            {
                ...
                if (e.BytesTransferred > 0 && e.SocketError == SocketError.Success)
                {
                    ...
                    do
                    {
                        ...
                        if (listener != null)
                            listener.OnReceiveData(token, rev);
        ...
        private void CloseClientSocket(SocketAsyncEventArgs e)
        {
            ...
            if (listener != null)
                listener.OnClientNumberChange(-1, token);
        ...
        public bool SendAllMessage(byte[] message)
        {
            bool isSuccess = true;
            foreach (var item in m_clients)
            {
                isSuccess = isSuccess && SendMessage(item, message);
            }
            return isSuccess;
        }
